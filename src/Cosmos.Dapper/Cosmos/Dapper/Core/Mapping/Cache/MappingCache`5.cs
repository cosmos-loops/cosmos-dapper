...
{
    internal static class MappingCache<T1, T2, T3, T4, T5>
    {
        static MappingCache()
        {
            ...
            Map = Expression.Lambda<Func<T1, T2, T3, T4, T5, T1>>(blockExpression, first, second, third, fourth, fifth).Compile();
        }

        internal static Func<T1, T2, T3, T4, T5, T1> Map { get; }
    }
}