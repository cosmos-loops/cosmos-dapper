...
{
    internal static class MappingCache<T1, T2, T3, T4, T5, T6>
    {
        static MappingCache()
        {
            ...
            var blockExpression = Expression.Block(first, second, third, fourth, fifth, sixth,
                secondSetExpression, thirdSetExpression, fourthSetExpression, fifthSetExpression, sixthSetExpression,
                first);

            Map = Expression.Lambda<Func<T1, T2, T3, T4, T5, T6, T1>>(blockExpression, first, second, third, fourth, fifth, sixth).Compile();
        }

        internal static Func<T1, T2, T3, T4, T5, T6, T1> Map { get; }
    }
}