...
namespace Cosmos.Dependency
{
    ...
    public static class DbContextDependencyExtensions
    {
        ...
        public static IDbContextConfig UseDapperWithSQLite(
        ...
        #region UseSQLiteDapperStrictly
        ...
        /// <returns></returns>
        // ReSharper disable once InconsistentNaming
        public static IDbContextConfig UseDapperWithSQLite<TContext>(
            this IDbContextConfig config,
            string name,
            string connectionString,
            Action<FluentMapConfiguration> configureConvention = null,
        ...
        /// <exception cref="ArgumentNullException"></exception>
        // ReSharper disable once InconsistentNaming
        public static IDbContextConfig UseDapperWithSQLite<TContext>(this IDbContextConfig config,
            string name,
            IConfiguration configuration,
            Action<FluentMapConfiguration> configureConvention = null,
            IList<Assembly> mappingAssemblies = null)
