...
namespace Cosmos.Dependency
{
    ...
    public static class DbContextDependencyExtensions
    {
        ...
        /// <returns></returns>
        public static IDbContextConfig UseDapperWithPostgreSql(
        ...
        #region UsePostgreSqlDapperStrictly

        /// <summary>
        /// Use Cosmos Dapper for PostgreSQL Strictly
        /// </summary>
        /// <param name="config"></param>
        /// <param name="name"></param>
        /// <param name="connectionString"></param>
        ...
        /// <returns></returns>
        public static IDbContextConfig UseDapperWithPostgreSql<TContext>(
            this IDbContextConfig config,
            string name,
            string connectionString,
            Action<FluentMapConfiguration> configureConvention = null,
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static IDbContextConfig UseDapperWithPostgreSql<TContext>(this IDbContextConfig config,
            string name,
            IConfiguration configuration,
            Action<FluentMapConfiguration> configureConvention = null,
            IList<Assembly> mappingAssemblies = null)
