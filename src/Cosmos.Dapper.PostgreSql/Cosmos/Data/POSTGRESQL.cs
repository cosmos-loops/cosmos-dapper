...
{
    /// <summary>
    /// PostgreSQL static helper with Dapper
    /// </summary>
    public static class PostgreSqlDapper
    {
        /// <summary>
        /// Get dapper client
        /// </summary>
        ...
        public static IDapperConnector GetClient(string connectionString, int? timeout = null)
        {
            ...
            var mappingConfig = new DapperConfig(new PostgreSqlDialect(), sqlKataCompiler, options, false);
        ...
        {
            ISqlKataCompilerCreator sqlKataCompiler = new SqlKataCompilerCreator<PostgresCompiler>();
            return new DapperConfig(new PostgreSqlDialect(), sqlKataCompiler, options, false);
        }
        ...
        public static ISQLActionEntry GetDapperAction(string connectionString, int? timeout = null)
        {
            ...
            var connector = new DapperConnector<NpgsqlConnection>(options.ToConn(), mappingConfig, new SQLGenerator(mappingConfig));
            var contextParams = new PostgreSqlContextParams(mappingConfig);
