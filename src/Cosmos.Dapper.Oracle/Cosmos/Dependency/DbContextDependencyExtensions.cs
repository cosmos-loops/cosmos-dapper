...
namespace Cosmos.Dependency
{
    ...
    {
        #region UseOracleDapper

        /// <summary>
        /// Use Cosmos Dapper for Oracle
        /// </summary>
        ...
        /// <returns></returns>
        public static IDbContextConfig UseDapperWithOracle(
        ...
        #region UseOracleDapperStrictly

        /// <summary>
        /// Use Cosmos Dapper for Oracle Strictly
        /// </summary>
        /// <param name="config"></param>
        /// <param name="name"></param>
        /// <param name="connectionString"></param>
        ...
        /// <returns></returns>
        public static IDbContextConfig UseDapperWithOracle<TContext>(
            this IDbContextConfig config,
            string name,
            string connectionString,
            Action<FluentMapConfiguration> configureConvention = null,
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static IDbContextConfig UseDapperWithOracle<TContext>(this IDbContextConfig config,
            string name,
            IConfiguration configuration,
            Action<FluentMapConfiguration> configureConvention = null,
            IList<Assembly> mappingAssemblies = null)
