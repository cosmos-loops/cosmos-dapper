...
namespace Cosmos.Data
{
    ...
    public static class SqlServerDapper
    {
        ...
        public static IDapperConnector GetClient(string connectionString, int? timeout = null)
        {
            ...
            var mappingConfig = new DapperConfig(new SqlServerDialect(), sqlKataCompiler, options, false);
        ...
        {
            ISqlKataCompilerCreator sqlKataCompiler = new SqlKataCompilerCreator<SqlServerCompiler>();
            return new DapperConfig(new SqlServerDialect(), sqlKataCompiler, options, false);
        }
        ...
        public static ISQLActionEntry GetDapperAction(string connectionString, int? timeout = null)
        {
            ...
            var connector = new DapperConnector<SqlConnection>(options.ToConn(), mappingConfig, new SQLGenerator(mappingConfig));
            var contextParams = new SqlServerContextParams(mappingConfig);
